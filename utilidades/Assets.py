...
class ASSETS(Enum):
    ...
    ENEMY_TANK_UP = ASSETS_DIR / "image" / "Enemy" /"enemy-tank-pointing-up.png"
    ENEMY_TANK_DOWN = ASSETS_DIR / "image" / "Enemy" / "enemy-tank-pointing-down.png"
    ENEMY_TANK_LEFT = ASSETS_DIR / "image" / "Enemy" /"enemy-tank-pointing-left.png"
    ENEMY_TANK_RIGHT = ASSETS_DIR / "image" / "Enemy" /"enemy-tank-pointing-right.png"
