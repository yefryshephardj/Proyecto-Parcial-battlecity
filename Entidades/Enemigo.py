...
class Enemigo:
    ...
    def load_sprites(self):
        ...
        # Cargar sprites específicos para enemigos
        front_image = pygame.image.load(
            str(ASSETS.ENEMY_TANK_DOWN.value)).convert_alpha()
        ...
        back_image = pygame.image.load(
            str(ASSETS.ENEMY_TANK_UP.value)).convert_alpha()
        ...
        right_image = pygame.image.load(
            str(ASSETS.ENEMY_TANK_RIGHT.value)).convert_alpha()
        ...
        left_image = pygame.image.load(
            str(ASSETS.ENEMY_TANK_LEFT.value)).convert_alpha()
